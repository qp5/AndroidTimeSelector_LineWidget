# Time-select-widget-LineWidget
Extends Androids TimePicker —  LineWidget provides quickly select / edit of day & time fields.<br>
...
This repository contains widget illustration only.<br>
